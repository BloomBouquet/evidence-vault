...
import { AuthEntryAction } from "@/src/components/auth/auth-entry-action";
import { AuthErrorNotice } from "@/src/components/auth/auth-error-notice";
import { AuthSessionProvider } from "@/src/components/auth/auth-session-provider";
    ...
    <AuthSessionProvider>
      <main className="landing-shell">
        <nav className="topbar" aria-label="주요 메뉴">
          ...
          <AuthEntryAction placement="nav" />
        </nav>

        <AuthErrorNotice code={authError} />
        ...
        <section className="hero">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <AuthEntryAction placement="hero" />
